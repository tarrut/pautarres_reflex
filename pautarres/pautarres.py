...
from .views.projects.mcp_weather_tool.mcp_weather_tool import mcp_weather_tool

app = rx.App()
app.add_page(index, route="./", title="Pau Tarrés")

app.add_page(
    project_page(airline_optimization()),
    route="./airline_optimization",
    title="Airline Optimization"
    )
app.add_page(
    project_page(john_draim_constellation()),
    route="./john_draim_constellation",
    title="John Draim's Constellation"
    )
app.add_page(
    project_page(personal_website()),
    route="./personal_website",
    title="Personal Website"
    )
app.add_page(
    project_page(nonlagrangian_finite_elements()),
    route="./nonlagrangian_finite_element",
    title="Non-Lagrangian Finite Elements"
    )
app.add_page(
    project_page(nonlagrangian_finite_elements()),
    route="./nonlagrangian_finite_element",
...
app.add_page(
    project_page(mcp_weather_tool()),
    route="./mcp_weather_tool",
    title="Current Weather MCP Tool"
    )
